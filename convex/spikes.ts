 ...
 *
 * The session-based design spike functions (designReport, finalPreset, the
 * replay experiment) were removed with the pre-band app in slice 3; their
 * results are recorded in docs/spikes/ and the plan's change log.
 *
